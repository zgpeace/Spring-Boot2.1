package zgpeace.spring.mybatis.mapper;
...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=zgpeace.spring.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("zgpeace.spring.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=zgpeace.spring.mybatis.handler.MoneyTypeHandler},",
